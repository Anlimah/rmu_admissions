                    ...
                    <section class="easy-apply">
                        ...
                        <div class="app-step row">
                            ...
                            <p class="col-11">
                                ...
                                <a href="https://foreign.rmuictonline.com">
                                    <span style="color: red; font-weight:bolder"> https://foreign.rmuictonline.com </span>
                        ...
                        <div class="app-step row">
                            ...
                            <p class="col-11">
                                ...
                                or dial the shortcode <span style="color: red; font-weight:bolder">*447*8#</span> (MTN and VODAFONE for applicants in Ghana only)
                                , or from any of our <span style="color: red; font-weight:bolder"><a href="#vendor-list">vendors listed here</a></span>.
                            </p>
                        </div>
                        <div class="app-step row">
                    ...
                    <section class="login">
                        ...
                        <div style="width:auto">
                            ...
                            <div class="card loginFormContainer" style="margin-bottom: 50px; margin-top: 50px; max-width: 360px">
                                ...
                                <form id="appLoginForm" style="margin: 0px 12% !important;" method="post">
